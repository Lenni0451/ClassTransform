...
class MemberCopyGeneralHandlerTest extends AnnotationHandlerTest {
    ...
    private void removeShadows(final ClassNode transformer) {
        ...
        shadowTransformer.transform(this.transformerManager, classTree, this.classProvider, this.injectionTargets, this.staticCalculatorClass, transformer);
        shadowTransformer.transform(this.transformerManager, classTree, this.classProvider, this.injectionTargets, this.virtualCalculatorClass, transformer);
    }
