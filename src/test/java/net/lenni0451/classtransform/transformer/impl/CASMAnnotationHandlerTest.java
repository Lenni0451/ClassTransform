...
class CASMAnnotationHandlerTest extends AnnotationHandlerTest {
    ...
    public void throwIfUsingInvalidOperations(final String transformerName) {
        ...
        assertThrows(IllegalStateException.class, () -> this.transformer.transform(this.transformerManager, classTree, this.classProvider, this.injectionTargets, this.staticCalculatorClass, transformer));
    }
